...
#' Time series decay
#'
#' Applies the specified decay on the input vector
#'
...
#' Hill Function
#'
#' Applies the Hill Function (1 - exp(-x)) on the input vector
#'
#' @param v Numeric vector
#' @param m Numeric integer or decimal
#' @param b Numeric integer or decimal
...
#'
#' Applies the negative exponential (1 - exp(-x/m)) on the input vector
#'
#' @param v Numeric vector
...
#' Lag by \code{l}
#'
#' Applies a lag of \code{l} on the input vector
#'
#' @param v Numeric vector
...
#'
#' @param v Numeric vector
#' @param width Width of moving average window as an integer
